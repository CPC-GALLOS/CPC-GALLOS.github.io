...
- Extensión de vscode para compilar en vscode web, posiblemente usando [vscode-wasm Public: WASI implementation](https://marketplace.visualstudio.com/items?itemName=ms-vscode.wasm-wasi-core)para llegar a tener algo como [Compiladores nativos web sin usar cloud](https://cpc-gallos.github.io/blog/Entorno_Desarrollo/#-compiladores-en-l%C3%ADnea-online) como el famoso [onlinegdb](https://www.onlinegdb.com/online_c++_compiler) dentro del mismo vscode, o integrarlo en [cph](https://marketplace.visualstudio.com/items?itemName=DivyanshuAgrawal.competitive-programming-helper) o [extensiones que se usen en programación competitiva](https://cpc-gallos.github.io/blog/Entorno_Desarrollo/#integrar-codeforces-con-vscode)
