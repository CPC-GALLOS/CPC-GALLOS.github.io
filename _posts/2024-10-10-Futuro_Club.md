...
5. **Involucración con la Universidad Autónoma de Aguascalientes (UAA)**
   ...
   - Que se implementen programas de empresas para Universidades como [Microsoft Learn for Educators (MSLE)](https://learn.microsoft.com/en-ca/answers/questions/5920028/how-to-get-free-azure-certification-student-vouche) para que nos den vouchers de certificacion de azure gratis, ya esta el depto de electronica de la UAA inscrito en el de [AWS academy](https://aws.amazon.com/training/awsacademy/) pero nunca esta de más tener opciones. Tambien considerar estos: [IBM Digital credentials for college students](https://skillsbuild.org/college-students/college-certificates), [Google AI for Education Accelerator](https://grow.google/certificates-academic-institutions/), [Google Cloud for Students](https://cloud.google.com/edu/students) y [GitHub Campus Program](https://education.github.com/discount_requests/application)(Free GitHub Enterprise Server and GitHub Enterprise Cloud).
...
- Extensión de vscode para compilar en vscode web, posiblemente usando [vscode-wasm Public: WASI implementation](https://marketplace.visualstudio.com/items?itemName=ms-vscode.wasm-wasi-core)/[container2wasm](https://github.com/container2wasm/container2wasm)para llegar a tener algo como [Compiladores nativos web sin usar cloud](https://cpc-gallos.github.io/blog/Entorno_Desarrollo/#-compiladores-en-l%C3%ADnea-online) como el famoso [onlinegdb](https://www.onlinegdb.com/online_c++_compiler) dentro del mismo vscode, o integrarlo en [cph](https://marketplace.visualstudio.com/items?itemName=DivyanshuAgrawal.competitive-programming-helper) o [extensiones que se usen en programación competitiva](https://cpc-gallos.github.io/blog/Entorno_Desarrollo/#integrar-codeforces-con-vscode)
- Entorno de programación seguro, sin AI y sin distracciones, para competencias, entrenamientos, entrevistas, assesments y examenes. Basandose quiza en crear una extensión de moodle + SafeExamBrowser (aunque por las modificaciónes del navegador puede no funcionar vscode web), o metodos no protectorados basados en APIs estándar del navegador, como Fullscreen API para detectar la salida del modo pantalla completa, Page Visibility API para identificar cambios de pestaña o minimización de la ventana, Focus/Blur API para detectar la pérdida del foco, eventos de ventana (resize, beforeunload) para monitorear cambios de tamaño e intentos de abandonar la evaluación, eventos de teclado (keydown, keyup) y del portapapeles (copy, cut, paste) para registrar determinadas interacciones del usuario, así como el evento contextmenu para detectar la apertura del menú contextual. De forma opcional, pueden incorporarse Screen Orientation API y Pointer Lock API para reforzar el control del entorno de evaluación, un ejemplo es lo que usan en el [examinator de epam](https://examinator.epam.com/).
