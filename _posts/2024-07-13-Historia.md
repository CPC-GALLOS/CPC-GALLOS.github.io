...
pin: false
mermaid: false
image: https://cdn.britannica.com/65/237365-138-03A2AF7F/did-you-know-The-School-of-Athens-Raphael.jpg
---
...
El presedente de nuestro club era el difunto **Club de Algoritmia GALLOS** (Club sin alcance público) el cual tuvo participación por primera vez en el ICPC del año 2022, donde un grupo logro irse a la regional del ICPC GPM en Guadalajara. Desgraciadamente debido al paso del tiempo los miembros originales tuvieron que dejar el club para ejercer las prácticas profesionales o incursionarse en el mundo laboral. El ultimo líder, [{{ site.data.authors.Chisrra.name }}]({{ site.data.authors.Chisrra.url }}), comenzó con la difusión del club hacia más carreras, estudiantes de la universidad y al publico en general, creando el [antiguo repositorio del club en GitHub](https://github.com/Chisrra/GALLOS), cuyo propósito era servir como guía para todos los interesados en la programación competitiva y para que cualquier persona que quisiera accediera a esos recursos.

En 2023 [{{ site.data.authors.Chisrra.name }}]({{ site.data.authors.Chisrra.url }}) dejo el cargo de líder del grupo a [{{ site.data.authors.ArielParra.name }}]({{ site.data.authors.ArielParra.url }}) de la carrera de ISC como el nuevo líder del club, donde se realizaron múltiples presentaciones diseñadas en marp y se cambio el nombre del club a **Club de Programación Competitiva GALLOS**, siendo este un nuevo y rediseñado club.
...
En el semestre enero-julio de 2026 [{{ site.data.authors.Dember.name }}]({{ site.data.authors.Dember.url }}) (Dember) y [{{ site.data.authors.SofiaLimon.name }}]({{ site.data.authors.SofiaLimon.url }}) 
dieron las sesiones del club, mientras que [{{ site.data.authors.ArielParra.name }}]({{ site.data.authors.ArielParra.url }}) haria por segundo año consecutivo el [Concurso de Programación del Congreso de Ciencias Exactas UAA](https://cpc-gallos.github.io/blog/Concursos/#concurso-de-programaci%C3%B3n-del-congreso-de-ciencias-exactas-uaa) siendo este el ultimo concurso que organizara como estudiante.

En el semestre agsoto-diciembre 2026, [{{ site.data.authors.SofiaLimon.name }}]({{ site.data.authors.SofiaLimon.url }}) se quedo como la lider del club y
[{{ site.data.authors.CarloMorales.name }}]({{ site.data.authors.CarloMorales.url }}) y [{{ site.data.authors.VictorNemer.name }}]({{ site.data.authors.VictorNemer.url }}) se incorporarian como coaches del Club dando clases ya que por primera vez tendriamos un aforo que necesitaria 2 laboratorios el del 203 y el 61, tambien se re-incorporaria [{{ site.data.authors.AlanMartinez.name }}]({{ site.data.authors.AlanMartinez.url }}) como coach del club, mientras que [{{ site.data.authors.ArielParra.name }}]({{ site.data.authors.ArielParra.url }}) apoyaria como Advisor del club.
